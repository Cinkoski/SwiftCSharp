...
namespace STUN
{
    public class STUNRfc5780
    {
        public static STUNQueryResult Query(Socket socket, IPEndPoint server, STUNQueryType queryType, int ReceiveTimeout)
        {
            ...
            message.Attributes.Add(new STUNChangeRequestAttribute());
            ...
            var mappedAddressAttribute = message.Attributes.FirstOrDefault(p => p is STUNMappedAddressAttribute)
            ...
            result.PublicEndPoint = mappedAddressAttribute.EndPoint;
            ...
            if (mappedAddressAttribute.EndPoint.Equals(socket.LocalEndPoint))
            {
            ...
            {
                if (mappedAddressAttribute.EndPoint.Equals(xorAddressAttribute2.EndPoint))
                {
